...
<div style="text-align:center">
    <img alt="Картинка" src="readme_images/Figure_1.png" width="70%" vspace="15" hspace="15">
</div>

<div style="text-align:center">
    <img alt="Картинка" src="readme_images/Figure_2.png" width="70%" vspace="15" hspace="15">
</div>
